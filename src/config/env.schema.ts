...
/**
 * Une variable declaree mais vide dans .env vaut "" et non undefined.
 * `.optional()` seul rejetterait donc une ligne `SUPABASE_URL=`.
 * On normalise la chaine vide en absence de valeur.
 */
